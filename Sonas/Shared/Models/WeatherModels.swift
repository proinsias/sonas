...
enum MoonPhase: String, CaseIterable, Equatable {
    ...
    var symbolName: String {
        switch self {
        case .newMoon: Icon.moonNew
        case .waxingCrescent: Icon.moonWaxingCrescent
        case .firstQuarter: Icon.moonFirstQuarter
        case .waxingGibbous: Icon.moonWaxingGibbous
        case .fullMoon: Icon.moonFull
        case .waningGibbous: Icon.moonWaningGibbous
        case .lastQuarter: Icon.moonLastQuarter
        case .waningCrescent: Icon.moonWaningCrescent
        }
    }
...
enum AQICategory: Equatable {
    ...
    var color: String { // Hex string for SwiftUI Color(hex:)
        ...
        case .unhealthySensitive: "#FF7E00"
        case .unhealthy: "#FF0000"
        case .veryUnhealthy: "#8F3F97"
        case .hazardous: "#7E0023"
        }
    }
}

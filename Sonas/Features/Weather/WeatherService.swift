...
enum WeatherServiceError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .locationNotConfigured:
            "Set your home location in Settings to view weather."
        case let .weatherKitUnavailable(err):
            "Weather service unavailable: \(err.localizedDescription)"
        case .aqiFetchFailed:
            nil // Non-fatal — weather still shown without AQI
        }
    }
}
